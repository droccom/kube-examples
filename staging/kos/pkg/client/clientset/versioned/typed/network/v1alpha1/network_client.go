...
import (
	...
	"k8s.io/examples/staging/kos/pkg/client/clientset/versioned/scheme"
)
...
// NetworkV1alpha1Client is used to interact with features provided by the network.example.com group.
type NetworkV1alpha1Client struct {
	restClient rest.Interface
}

func (c *NetworkV1alpha1Client) IPLocks(namespace string) IPLockInterface {
	return newIPLocks(c, namespace)
}

func (c *NetworkV1alpha1Client) NetworkAttachments(namespace string) NetworkAttachmentInterface {
