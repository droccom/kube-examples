...
type IPLockInterface interface {
	Create(*v1alpha1.IPLock) (*v1alpha1.IPLock, error)
	Update(*v1alpha1.IPLock) (*v1alpha1.IPLock, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.IPLock, error)
	List(opts v1.ListOptions) (*v1alpha1.IPLockList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.IPLock, err error)
	IPLockExpansion
}
...
func newIPLocks(c *NetworkV1alpha1Client, namespace string) *iPLocks {
	return &iPLocks{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *iPLocks) Get(name string, options v1.GetOptions) (result *v1alpha1.IPLock, err error) {
...
func (c *iPLocks) List(opts v1.ListOptions) (result *v1alpha1.IPLockList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.IPLockList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("iplocks").
...
func (c *iPLocks) Create(iPLock *v1alpha1.IPLock) (result *v1alpha1.IPLock, err error) {
	result = &v1alpha1.IPLock{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iplocks").
...
func (c *iPLocks) Update(iPLock *v1alpha1.IPLock) (result *v1alpha1.IPLock, err error) {
	result = &v1alpha1.IPLock{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iplocks").
...
func (c *iPLocks) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.IPLock, err error) {
	result = &v1alpha1.IPLock{}
