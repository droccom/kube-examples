	...
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Required: []string{"exitStatus", "stdOut", "stdErr"},
			},
		},
		Dependencies: []string{
...
func schema_pkg_apis_network_v1alpha1_NetworkAttachment(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.NetworkAttachmentSpec", "k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.NetworkAttachmentStatus"},
	}
}
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"postCreateExecReport": {
						SchemaProps: spec.SchemaProps{
							Description: "PostCreateExecReport, if non-nil, reports on the run of the PostCreateExec.",
...
func schema_pkg_apis_network_v1alpha1_Subnet(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.SubnetSpec", "k8s.io/examples/staging/kos/pkg/apis/network/v1alpha1.SubnetStatus"},
	}
}
